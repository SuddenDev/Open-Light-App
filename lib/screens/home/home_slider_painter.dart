...
class HomeSliderPainter extends CustomPainter {
  ...
  HomeSliderPainter({
    ...
    this.shadowDistance = 1.0,
  }): this.innerShadowTopColor = Colors.blueGrey[500],
      this.innerShadowBottomColor = Colors.blueGrey[50],
      fillPainter = Paint()
      ..color = color
      ...
      ..strokeWidth = 2.5
      ..maskFilter = MaskFilter.blur(BlurStyle.outer, _convertRadiusToSigma(6))
      ;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // glow drawing
    canvas.drawPath(_glowBars, Paint()
    ...
    // Dark Shadow
    canvas.drawPath(_innerShadowTop, shadowPainter..color = innerShadowTopColor);
    
    // Bright Shadow
    canvas.drawPath(_innerShadowBottom, shadowPainter..color = innerShadowBottomColor);
  ...
  void _addToInnerShadowBottom(Canvas canvas, Size size, int index) {
    _innerShadowBottom.addPath(
      Path()
        ...
        ..lineTo(size.width - padding + shadowDistance, lineHeight + shadowDistance)
